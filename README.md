...
<body>
    ...
    const DATA = {
      'wall-power': {
        getHTML: () => `
          <div class="tab-navigation">
            <button class="tab-btn active" data-tab="overview"><span class="tab-icon">ℹ️</span>Overview</button>
            <button class="tab-btn" data-tab="flow"><span class="tab-icon">⚡</span>Power Flow</button>
            <button class="tab-btn" data-tab="technical"><span class="tab-icon">🔧</span>Technical</button>
            <button class="tab-btn" data-tab="operation"><span class="tab-icon">⚙️</span>Operation</button>
          </div>
          ...
          <div class="tab-content" id="tab-flow">
            ...
            <p style="color:#94a3b8;text-align:center;margin-bottom:1rem;">💡 <strong style="color:#fbbf24;">Click on any colored box</strong> for details</p>
            ...
            <div class="flow-diagram">
              ...
              <div style="text-align:center;font-size:2rem;color:#94a3b8;margin:1rem 0;">↓</div>
              ...
              <div style="text-align:center;font-size:1.5rem;color:#94a3b8;margin:1rem 0;">↓ Split Path</div>
              ...
              <div class="split-path">
                ...
                <div class="path-box path-green" data-power-component="outlet-120v">
                  ...
                  <p style="margin-top:0.5rem;font-size:0.75rem;color:#94a3b8;line-height:1.4;">Feeders (Almond/Clay/White) • Cabinets (L/R) • Controls (L/R) • Computer • Aux</p>
                </div>
              </div>
            </div>
            ...
            <div class="power-flow-detail" id="powerFlowDetail">
              <div class="power-detail-header">
                ...
                <button class="power-detail-close" id="powerDetailClose">✕ Close</button>
              </div>
      ...
      'power': {
        getHTML: () => `
          <div class="tab-navigation">
            <button class="tab-btn active" data-tab="overview"><span class="tab-icon">ℹ️</span>Overview</button>
            <button class="tab-btn" data-tab="flow"><span class="tab-icon">⚡</span>Flow Diagram</button>
            <button class="tab-btn" data-tab="technical"><span class="tab-icon">🔧</span>Technical</button>
            <button class="tab-btn" data-tab="operation"><span class="tab-icon">⚙️</span>Operation</button>
          </div>
          ...
          <div class="tab-content" id="tab-flow">
            ...
            <p style="color:#94a3b8;text-align:center;margin-bottom:1.5rem;">💡 <strong style="color:#fbbf24;">Click on any colored box</strong> for detailed component information</p>
            ...
            <div class="flow-diagram">
              ...
              <div style="text-align:center;margin-bottom:1rem;">
                <div style="display:inline-block;padding:0.5rem 1rem;background:rgba(239,68,68,0.2);border-radius:0.5rem;border:2px solid #ef4444;">
                  <strong style="color:#ef4444;font-size:1.1rem;">⚡ STAGE 1: AC INPUT</strong>
                </div>
              </div>
              ...
              <div style="text-align:center;margin:1.5rem 0;">
                <div style="display:inline-block;color:#60a5fa;font-size:2rem;">↓</div>
              ...
              <div style="text-align:center;margin-bottom:1rem;">
                <div style="display:inline-block;padding:0.5rem 1rem;background:rgba(251,146,60,0.2);border-radius:0.5rem;border:2px solid #fb923c;">
                  <strong style="color:#fb923c;font-size:1.1rem;">🛡️ STAGE 2: PROTECTION LAYER</strong>
                </div>
              </div>
              ...
              <div style="text-align:center;margin-bottom:1rem;">
                <div style="display:inline-block;padding:0.5rem 1rem;background:rgba(168,85,247,0.2);border-radius:0.5rem;border:2px solid #a855f7;">
                  <strong style="color:#a855f7;font-size:1.1rem;">🔐 STAGE 3: SAFETY CONTROL</strong>
                </div>
              </div>
              ...
              <div style="display:flex;justify-content:center;gap:2rem;margin-bottom:1rem;flex-wrap:wrap;">
                <div style="text-align:center;">
                  ...
                  <div style="color:#94a3b8;font-size:0.75rem;margin-top:0.5rem;">Controls ↓</div>
                </div>
              ...
              <div style="text-align:center;margin-bottom:1rem;">
                <div style="display:inline-block;padding:0.5rem 1rem;background:rgba(234,179,8,0.2);border-radius:0.5rem;border:2px solid #eab308;">
                  <strong style="color:#eab308;font-size:1.1rem;">📊 STAGE 4: POWER SUPPLIES</strong>
                </div>
              </div>
              ...
              <div style="text-align:center;margin:1.5rem 0;">
                <div style="display:inline-block;color:#60a5fa;font-size:1.5rem;">↓ ↓ ↓</div>
            ...
            <div class="info-box" style="margin-top:2rem;">
              ...
              <ul style="color:#cbd5e1;line-height:1.8;">
                ...
                <li><strong>Safety:</strong> Any E-stop → DOLD drops → Finder opens → Instant power cutoff</li>
              </ul>
            </div>
          </div>
  ...
  <div class="operation-sequence">
    <h4>🔄 DOLD Safety Relay Operation Sequence:</h4>
    <div class="operation-step">
      <div class="step-number">1</div>
    ...
    <div class="operation-step">
      <div class="step-number">2</div>
      <div class="step-content">Checks S11 → S12 and S11 → S22 safety circuit continuity</div>
    </div>
    <div class="operation-step">
      <div class="step-number">3</div>
  ...
  <div class="danger-box">
    <h4>⚠️ Safety Event Response:</h4>
    <p>Any safety event (E-stop pressed or light curtain broken) → S12/S22 contacts open → DOLD drops K1/K2 → Finder relay de-energizes → Machine loses power instantly.</p>
  ...
  <div class="info-box">
    ...
    <div style="margin-top:1rem;margin-bottom:1rem;">
      ...
      <div class="specs-grid">
        <div class="spec-row"><span class="spec-label">Terminals:</span><span class="spec-value">1→3 and 2→4</span></div>
  ...
  <div class="terminal-block">
    ...
    <p style="color:#94a3b8;margin-top:1rem;"><strong>Power Flow:</strong> NDR-120 → UKK80 → Phoenix terminals → distributed to all devices. Each device gets: one wire from red terminal (+24V), one from black terminal (0V return), forming complete electrical loop.</p>
  </div>
</div>
  ...
  <div class="operation-sequence">
    ...
    <div class="operation-step">
      <div class="step-number">4</div>
      <div class="step-content">
        <strong>DOLD Self-Test:</strong> DOLD D-78120 safety relay powers on, performs self-test, and monitors safety circuit (S11→S12, S11→S22, S21)
      </div>
    </div>
    <div class="operation-step">
      <div class="step-number">5</div>
    ...
    <div class="operation-step">
      <div class="step-number">7</div>
      <div class="step-content">
        <strong>Finder Activation:</strong> DOLD output energizes Finder contactor coil (A1-A2), causing magnetic field to close power contacts 1→3 and 2→4
      </div>
    </div>
    <div class="operation-step">
      <div class="step-number">8</div>
  ...
  <div class="danger-box">
    <h4>⚡ Emergency Shutdown Sequence:</h4>
    ...
    <div class="operation-step" style="background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.3);">
      <div class="step-number" style="background:#ef4444;">!</div>
      <div class="step-content">
        <strong>Power Cutoff:</strong> Finder contacts 1→3 and 2→4 open, disconnecting AC power
      </div>
    </div>
    <div class="operation-step" style="background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.3);">
      <div class="step-number" style="background:#ef4444;">!</div>
  ...
  <div class="warning-box">
    <h4>⚠️ Safety Restart Procedure:</h4>
    ...
    <ul>
      ...
      'motor-control': {
        getHTML: () => `
          <div class="tab-navigation">
            <button class="tab-btn active" data-tab="overview"><span class="tab-icon">ℹ️</span>Overview</button>
            <button class="tab-btn" data-tab="flow"><span class="tab-icon">🎛️</span>Control Flow</button>
            <button class="tab-btn" data-tab="technical"><span class="tab-icon">🔧</span>Technical</button>
            <button class="tab-btn" data-tab="operation"><span class="tab-icon">⚙️</span>Operation</button>
          </div>
          ...
          <div class="tab-content active" id="tab-overview">
            ...
            <div class="warning-box">
              <h4>⚠️ Critical Safety Features:</h4>
            ...
            <div class="info-box">
              <h4>🔄 Closed-Loop Servo Operation:</h4>
            ...
            <div class="flow-diagram">
              <h4 style="color:#60a5fa;margin-bottom:1.5rem;">🔌 Simple Power Flow Overview</h4>
              ...
              <div class="flow-stage">
                <div class="flow-box" style="background:#8b5cf6;color:white;flex:2;cursor:pointer;" data-motor-component="power-cabinet-summary">
                  ...
                  <div style="font-size:0.75rem;margin-top:0.5rem;opacity:0.9;">48V • 24V • 12V • 5V</div>
                </div>
                <div class="flow-arrow">→</div>
              ...
              <div style="text-align:center;margin:2rem 0;">
                <div style="display:inline-block;background:rgba(59,130,246,0.1);border:1px solid rgba(59,130,246,0.3);padding:1rem 1.5rem;border-radius:0.5rem;">
                  <p style="color:#60a5fa;font-size:0.9rem;margin:0;"><strong>💡 That's it!</strong> Power flows from Power Supply PCUs → through Phoenix terminal blocks → to the 4 motor control boards</p>
                </div>
              </div>
            </div>
            ...
            <div class="info-box" style="border-left-color:#8b5cf6;">
              <h4 style="cursor:pointer;user-select:none;" onclick="this.parentElement.querySelector('.detail-content').classList.toggle('active')">
                📦 Power Supply PCUs (Click to expand) ▼
              </h4>
              <div class="detail-content" style="display:none;margin-top:1rem;">
                <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1rem;">
                  <div style="background:rgba(220,38,38,0.1);padding:1rem;border-radius:0.5rem;border:1px solid rgba(220,38,38,0.3);cursor:pointer;" data-motor-component="sdr-480-48">
                    ...
                    <p style="margin:0.5rem 0 0 0;font-size:0.85rem;">48V DC → Motor power (Vmain)</p>
                  </div>
                  <div style="background:rgba(249,115,22,0.1);padding:1rem;border-radius:0.5rem;border:1px solid rgba(249,115,22,0.3);cursor:pointer;" data-motor-component="ndr-240-24">
                    ...
                    <p style="margin:0.5rem 0 0 0;font-size:0.85rem;">24V DC → Logic power (Vlogic)</p>
                  </div>
                  <div style="background:rgba(59,130,246,0.1);padding:1rem;border-radius:0.5rem;border:1px solid rgba(59,130,246,0.3);cursor:pointer;" data-motor-component="ndr-120-12">
                    ...
                    <p style="margin:0.5rem 0 0 0;font-size:0.85rem;">12V DC → Auxiliary systems</p>
                  </div>
                  <div style="background:rgba(34,197,94,0.1);padding:1rem;border-radius:0.5rem;border:1px solid rgba(34,197,94,0.3);cursor:pointer;" data-motor-component="mean-well-5v">
                    ...
                    <p style="margin:0.5rem 0 0 0;font-size:0.85rem;">5V DC → Sensors & encoders</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="info-box" style="border-left-color:#dc2626;">
              <h4 style="cursor:pointer;user-select:none;" onclick="this.parentElement.querySelector('.detail-content').classList.toggle('active')">
                🔌 Phoenix Terminals (Click to expand) ▼
              </h4>
              <div class="detail-content" style="display:none;margin-top:1rem;">
                <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1rem;">
            ...
            <div class="info-box" style="border-left-color:#c084fc;">
              <h4 style="cursor:pointer;user-select:none;" onclick="this.parentElement.querySelector('.detail-content').classList.toggle('active')">
                🔗 WAGO Splicing System (Click to expand) ▼
              </h4>
              <div class="detail-content" style="display:none;margin-top:1rem;">
                <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1rem;">
            ...
            <div class="flow-diagram" style="margin-top:2rem;">
              <h4 style="color:#4ade80;margin-bottom:1rem;">🎮 Control Signal Flow</h4>
              <div class="flow-stage">
            ...
            <div class="warning-box" style="margin-top:2rem;">
              <h4>🔑 Key Communication Protocol</h4>
  ...
  <div class="info-box">
    <h4>🔌 Power Conversion Units (PCUs) from Power Supply</h4>
    ...
    <div class="terminal-block">
      ...
      <div class="specs-grid">
        ...
        <div class="spec-row"><span class="spec-label">Distribution:</span><span class="spec-value">Phoenix Red terminal → 4 motor control boards</span></div>
      </div>
    ...
    <div class="terminal-block">
      ...
      <div class="specs-grid">
        ...
        <div class="spec-row"><span class="spec-label">Distribution:</span><span class="spec-value">Phoenix Red → WAGO 221 → All 4 boards</span></div>
      </div>
    ...
    <div class="terminal-block">
      ...
      <div class="specs-grid">
        ...
        <div class="spec-row"><span class="spec-label">Distribution:</span><span class="spec-value">Phoenix Red terminal → Sensors</span></div>
      </div>
  ...
  <div class="info-box">
    <h4>🔧 Phoenix Terminal Block Distribution System</h4>
  ...
  <div class="info-box">
    <h4>⚡ Communication Ports (Left Side)</h4>
    <div class="specs-grid">
      ...
      <div class="spec-row"><span class="spec-label">RS485– / RS485+:</span><span class="spec-value">Serial communication lines (Modbus or similar)</span></div>
  ...
  <div class="info-box">
    <h4>📥 Input / Feedback Ports (Top Middle)</h4>
    <div class="specs-grid">
  ...
  <div class="terminal-block">
    ...
    <div class="note-callout">
      <strong>ENC_A + ENC_B = Closed-Loop Stepper</strong> → Acts as a servo motor with position verification and error correction
    </div>
  </div>
  ...
  <div class="terminal-block">
    ...
    <div class="warning-box" style="margin-top:0.75rem;">
      <p><strong>⚠️ Important:</strong> STOP_L and STOP_R both force the motor to stop but DO NOT cut power to the driver. The motor remains energized and holding position.</p>
    </div>
  </div>
  ...
  <div class="terminal-block">
    ...
    <div class="warning-box" style="margin-top:0.75rem;">
      <h4 style="color:#fbbf24;">⚠️ Special Z-Axis Configuration:</h4>
  ...
  <div class="info-box">
    <h4>🔌 Motor Outputs (Right Side)</h4>
    <div class="specs-grid">
  ...
  <div class="info-box">
    <h4>⚡ Power Inputs (Bottom)</h4>
    <div class="specs-grid">
      <div class="spec-row"><span class="spec-label">Vlogic:</span><span class="spec-value">Low-voltage logic power (5–24V depending on board)</span></div>
  ...
  <div class="info-box">
    <h4>📏 Encoder Bundles: X-LIN / Y-LIN / Z-LIN</h4>
  ...
  <div class="info-box">
    <h4>🏠 Home Sensors: X-START / Y-START / Z-START</h4>
    ...
    <div style="margin-bottom:1rem;">
      ...
      <div class="operation-step" style="margin-bottom:0.5rem;">
        <div class="step-number">3</div>
        <div class="step-content">The sensor sends a signal (Black wire) to motor driver → controller</div>
      </div>
      <div class="operation-step" style="margin-bottom:0.5rem;">
        <div class="step-number">4</div>
        <div class="step-content">When beam is blocked → START is triggered → axis at home position</div>
      </div>
    </div>
  </div>
  
  <div class="terminal-block">
    <h4>🔗 WAGO Terminal Connections</h4>
  ...
  <div class="operation-sequence">
    <h4>🔄 Complete System Startup Sequence:</h4>
    <div class="operation-step">
      <div class="step-number">1</div>
      <div class="step-content">
  ...
  <div class="operation-sequence">
    <h4>🏠 Homing Sequence (Establishing Zero Position):</h4>
    <div class="operation-step">
      <div class="step-number">1</div>
      <div class="step-content">
  ...
  <div class="operation-sequence">
    <h4>🎯 Motion Control Operation:</h4>
    <div class="operation-step">
      <div class="step-number">1</div>
      <div class="step-content">
  ...
  <div class="danger-box">
    <h4>🛑 Soft-Stop Limit Switch Response (STOP_L / STOP_R):</h4>
  ...
  <div class="info-box">
    <h4>🔧 Encoder Feedback (Closed-Loop Operation):</h4>
    ...
    <ul>
      ...
      'left-feeder': {
        getHTML: () => `
          <div class="tab-navigation">
            <button class="tab-btn active" data-tab="overview"><span class="tab-icon">ℹ️</span>Overview</button>
            <button class="tab-btn" data-tab="flow"><span class="tab-icon">🔌</span>Signal Flow</button>
            <button class="tab-btn" data-tab="technical"><span class="tab-icon">🔧</span>Technical</button>
            <button class="tab-btn" data-tab="operation"><span class="tab-icon">⚙️</span>Operation</button>
          </div>
          ...
          <div class="tab-content" id="tab-flow">
            ...
            <div style="display:flex;flex-direction:column;align-items:center;gap:2rem;padding:2rem;background:rgba(15,23,42,0.5);border-radius:1rem;overflow-x:auto;">
              ...
              <div style="display:flex;flex-direction:column;align-items:center;gap:1.5rem;">
                ...
                <div style="font-size:3rem;color:#60a5fa;font-weight:bold;">↓</div>
                ...
                <div style="display:flex;flex-direction:column;align-items:center;gap:1.5rem;min-width:320px;">
                  ...
                  <div style="display:flex;gap:3rem;margin-top:1rem;flex-wrap:wrap;justify-content:center;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;gap:1rem;">
                      <div style="font-size:2rem;color:#a78bfa;font-weight:700;">↓ V+/V-</div>
                      <div class="clickable-component flow-box flow-box-purple" data-component="driver" style="width:180px;text-align:center;padding:1rem;">
                        ...
                        <div style="margin-top:0.75rem;padding-top:0.75rem;border-top:2px dashed rgba(251,191,36,0.5);">
                          <div style="font-size:0.8rem;color:#fbbf24;font-weight:600;">← 5V logic</div>
                          <div style="font-size:0.75rem;color:#fbbf24;">(PU, DR, MF)</div>
                        </div>
                      </div>
                      <div style="font-size:2.5rem;color:#a78bfa;font-weight:bold;">↓</div>
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;gap:1rem;">
                      <div style="font-size:2rem;color:#f87171;font-weight:700;">↓ 24V</div>
                      ...
                      <div style="display:flex;gap:2rem;margin-top:0.5rem;">
                        <div style="display:flex;flex-direction:column;align-items:center;gap:0.75rem;">
                          <div style="font-size:1.5rem;color:#f87171;font-weight:bold;">↓ Pin 11</div>
                          <div class="clickable-component flow-box flow-box-orange" data-component="relays" style="width:140px;text-align:center;padding:0.75rem;">
                            ...
                            <span style="font-size:0.8rem;">11 → 14</span>
                            <div style="margin-top:0.5rem;padding-top:0.5rem;border-top:2px dashed rgba(251,191,36,0.5);pointer-events:none;">
                              <div style="font-size:0.75rem;color:#fbbf24;font-weight:600;">← A1/A2</div>
                            </div>
                          </div>
                          <div style="font-size:1.5rem;color:#f87171;font-weight:bold;">↓ Pin 14</div>
                        ...
                        <div style="display:flex;flex-direction:column;align-items:center;gap:0.75rem;">
                          <div style="font-size:1.5rem;color:#f87171;font-weight:bold;">↓</div>
                ...
                <div style="display:flex;flex-direction:column;align-items:center;gap:1.5rem;min-width:320px;">
                  ...
                  <div style="margin-top:1.5rem;padding:2rem;background:linear-gradient(135deg,rgba(139,92,246,0.15),rgba(139,92,246,0.05));border:3px solid #8b5cf6;border-radius:1rem;min-width:300px;box-shadow:0 4px 20px rgba(139,92,246,0.3);">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;gap:1.5rem;">
                      ...
                      <!-- 5V PSU text at top -->
                      <div style="font-size:0.95rem;color:#8b5cf6;font-weight:600;text-align:center;">5V from PSU ↓</div>
                      ...
                      <div style="font-size:2rem;color:#fbbf24;font-weight:bold;">↓</div>
                      ...
                      <!-- Loop arrow back -->
                      <div style="font-size:2rem;color:#8b5cf6;font-weight:bold;">↓</div>
                  ...
                  <div style="margin-top:1.5rem;padding:1.25rem;background:rgba(6,182,212,0.1);border:2px dashed #06b6d4;border-radius:0.75rem;width:100%;max-width:300px;">
                    ...
                    <div style="font-size:0.9rem;color:#cbd5e1;line-height:2;">
                      <div style="font-weight:600;">→ Driver (PU-, DR-)</div>
                      <div style="font-weight:600;">→ Relay (A1/A2)</div>
                      <div style="font-weight:600;">← Sensors (OUT1)</div>
                    </div>
                  </div>
            ...
            <div id="component-side-panel" class="component-side-panel">
              <div class="side-panel-header">
                ...
                <button class="panel-close-btn" onclick="closeComponentPanel()">✕</button>
              </div>
...
<div class="tab-content" id="tab-technical">
            ...
            <h4 style="font-weight:700;margin:1.5rem 0 1rem;color:#cbd5e1;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">🧠 Control & Logic</h4>
            ...
            <!-- SENSING SECTION -->
            <h4 style="font-weight:700;margin:1.5rem 0 1rem;color:#cbd5e1;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">👁️ Sensors & Detection</h4>
            ...
            <div class="info-box">
              ...
              <div class="note-callout" style="background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
                ...
                <ul style="margin-top:0.5rem;margin-left:1.5rem;color:#cbd5e1;line-height:1.6;">
                  <li><strong>Beam Clear:</strong> LED light hits phototransistor → OUT1 goes HIGH</li>
                  <li><strong>Beam Blocked:</strong> Part/flag blocks slot → OUT1 goes LOW</li>
            ...
            <h4 style="font-weight:700;margin:1.5rem 0 1rem;color:#cbd5e1;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">⚡ Power & Protection</h4>
            ...
            <div class="info-box">
              ...
              <p style="margin-top:0.75rem;color:#94a3b8;"><strong>Power Flow:</strong> Wall AC → Nader Circuit Breaker → Doepke G16 → UKK160 → Power Supplies</p>
            </div>
            ...
            <div class="info-box">
              ...
              <div class="note-callout" style="background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
                ...
                <ul style="margin-top:0.5rem;margin-left:1.5rem;color:#cbd5e1;line-height:1.6;">
                  <li><strong>Neutral UKK160:</strong> Terminal 6 → connects to Doepke G16 Pin 2</li>
                  <li><strong>Line UKK160:</strong> Terminal 7 → connects to Doepke G16 Pin 4</li>
            ...
            <!-- ACTUATION SECTION -->
            <h4 style="font-weight:700;margin:1.5rem 0 1rem;color:#cbd5e1;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">💨 Pneumatic Actuation</h4>
            ...
            <div class="info-box">
              ...
              <div class="note-callout" style="background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
                ...
                <ol style="margin-top:0.5rem;margin-left:1.5rem;color:#cbd5e1;line-height:1.6;">
                  ...
                  <li>+24V flows from Red Phoenix Terminal → Pin 11 → Pin 14 → Solenoid V+</li>
            ...
            <div class="info-box">
              ...
              <p style="margin-top:0.75rem;color:#94a3b8;"><strong>Operation:</strong> When relay closes, 24V appears at V+ → current flows through coil → coil becomes electromagnet → valve shifts → air flows to cylinder → mechanical action occurs. When relay opens, spring returns valve to idle position.</p>
            </div>
            ...
            <!-- SYSTEM ARCHITECTURE -->
            <h4 style="font-weight:700;margin:1.5rem 0 1rem;color:#cbd5e1;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">🔗 System Architecture</h4>
            
            <div class="info-box">
              <h4>Command Chain: DN31C01 → Driver → Motor</h4>
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                ...
                <ul style="margin-left:1.5rem;margin-top:0.5rem;">
                  ...
                  <li><strong>Generate Pulses:</strong> STEP pin receives pulse train from controller
                    <ul style="margin-left:1.5rem;margin-top:0.25rem;">
                      ...
                      <li>Ramp profile: acceleration → constant velocity → deceleration</li>
                    </ul>
                  </li>
                ...
                <div class="warning-box" style="margin-top:1rem;">
                  <h4>⚠️ Limit Switch Protection:</h4>
              ...
              <div class="step-content">
                ...
                <div style="background:rgba(15,23,42,0.5);padding:1rem;border-radius:0.5rem;margin-top:0.75rem;">
                  <ol style="margin-left:1.5rem;color:#cbd5e1;line-height:1.6;">
                    ...
                    <li><strong>Power Path:</strong> Red Terminal (+24V) → Pin 2 → Relay (11-14) → Pin 1 → Solenoid V+</li>
                    <li><strong>Solenoid Energizes:</strong> 24V flows through solenoid coil → valve opens</li>
                    ...
                    <li><strong>De-energize:</strong> Controller outputs LOW → relay coil releases → contacts open → solenoid closes</li>
                  </ol>
                </div>
                ...
                <div class="specs-grid" style="margin-top:1rem;">
                  ...
                  <div class="spec-row"><span class="spec-label">Return Path:</span><span class="spec-value">Solenoid GND → Pin 5 → Black Terminal (0V)</span></div>
                </div>
              </div>
            </div>
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                ...
                <div class="note-callout" style="background:rgba(34,197,94,0.1);border-left:4px solid #22c55e;padding:0.75rem;margin-top:0.75rem;">
                  ...
                  <p style="color:#cbd5e1;margin-top:0.5rem;">→ Controller sends <strong>MOVE_COMPLETE</strong> signal to main system</p>
                </div>
                
                <div class="warning-box" style="margin-top:1rem;">
                  <h4>⚠️ ERROR Conditions:</h4>
                  <ul style="margin-left:1.5rem;">
                  ...
                  <p style="color:#cbd5e1;margin-top:0.5rem;">→ Controller sends <strong>FAULT</strong> signal and halts system</p>
                </div>
              </div>
            </div>
              ...
              <div class="step-content">
                ...
                <div class="info-box" style="margin-top:1rem;">
                  ...
                  <ol style="margin-left:1.5rem;color:#cbd5e1;line-height:1.6;margin-top:0.5rem;">
                    <li>Move to Position A → Activate relay 1 → Fire solenoid 1 → Detect part</li>
                    <li>Move to Position B → Activate relay 2 → Fire solenoid 2 → Confirm feed</li>
                    <li>Return to Home → All relays off → Wait for next cycle trigger</li>
                  </ol>
            ...
            <div class="info-box" style="margin-top:2rem;">
              <h4>🔧 Key Operational Parameters:</h4>
              <div class="specs-grid" style="margin-top:1rem;">
            ...
            <div class="warning-box" style="margin-top:1.5rem;">
              <h4>⚠️ Safety & Maintenance Notes:</h4>
              <ul>
      ...
      'right-feeder': {
        getHTML: () => `
          ...
          <div class="tab-content active" id="tab-overview">
            ...
            <div class="info-box">
              ...
              <ul>
                ...
                <li><strong>Stepper Motor:</strong> X-Axis bipolar stepper motor (4-wire: A+/A−, B+/B−)</li>
              ...
              <div style="display:flex;gap:5rem;margin-top:2rem;flex-wrap:wrap;justify-content:center;align-items:flex-start;">
                ...
                <div style="display:flex;flex-direction:column;align-items:center;gap:1.5rem;min-width:320px;">
                  ...
                  <div style="display:flex;gap:2rem;margin-top:1rem;flex-wrap:wrap;justify-content:center;">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;gap:1rem;">
                      <div style="font-size:2rem;color:#10b981;font-weight:700;">↓ Vcc</div>
                      <div class="clickable-component flow-box flow-box-green" data-component="ee-sx950w" style="width:180px;text-align:center;padding:1rem;">
                        ...
                        <div style="margin-top:0.75rem;padding-top:0.75rem;border-top:2px dashed rgba(251,191,36,0.5);">
                          <div style="font-size:0.75rem;color:#fbbf24;font-weight:600;">OUT1 → DN31C01</div>
                        </div>
                      </div>
                    </div>
                ...
                <div style="display:flex;flex-direction:column;align-items:center;gap:1.5rem;min-width:320px;">
                  ...
                  <div style="margin-top:1.5rem;padding:2rem;background:linear-gradient(135deg,rgba(139,92,246,0.15),rgba(139,92,246,0.05));border:3px solid #8b5cf6;border-radius:1rem;min-width:300px;box-shadow:0 4px 20px rgba(139,92,246,0.3);">
                    ...
                    <div style="display:flex;flex-direction:column;align-items:center;gap:1.5rem;">
                      ...
                      <!-- Control signals down arrow -->
                      <div style="font-size:2rem;color:#fbbf24;font-weight:bold;">↓</div>
                      <div style="font-size:0.9rem;color:#fbbf24;font-weight:600;">PU+/PU−, DR+/DR− signals</div>
                      <div style="font-size:2rem;color:#fbbf24;font-weight:bold;">↓</div>
                  ...
                  <div style="margin-top:1.5rem;padding:1.25rem;background:rgba(6,182,212,0.1);border:2px dashed #06b6d4;border-radius:0.75rem;width:100%;max-width:300px;">
                    <div style="font-size:1rem;font-weight:700;color:#06b6d4;text-align:center;margin-bottom:0.75rem;">DN31C01 CONTROLS:</div>
                    <div style="font-size:0.9rem;color:#cbd5e1;line-height:2;">
                      <div style="font-weight:600;">→ NOM Driver (PU, DR, MF)</div>
                      <div style="font-weight:600;">→ 6x Solenoid Relays</div>
                      <div style="font-weight:600;">← EE-SX950W (OUT1)</div>
                    </div>
                  </div>
            ...
            <div style="margin-top:1.5rem;padding:1.5rem;background:rgba(251,191,36,0.1);border:2px solid #fbbf24;border-radius:0.75rem;">
              <h4 style="color:#fbbf24;margin-bottom:1rem;font-size:1.1rem;">⚡ Right Rear Feeder Pneumatic Configuration</h4>
          ...
          <div class="tab-content" id="tab-technical">
            ...
            <!-- POWER SYSTEM -->
            <h4 style="color:#60a5fa;font-weight:700;margin:2rem 0 1rem;font-size:1.2rem;">⚡ Power Distribution System</h4>
            ...
            <div class="info-box">
              ...
              <div class="specs-grid">
                ...
                <div class="spec-row"><span class="spec-label">Output:</span><span class="spec-value">DC:20-50V V+ / V−</span></div>
              ...
              <ul style="color:#cbd5e1;line-height:1.6;margin-left:1.5rem;">
                ...
                <li><strong>V+:</strong> To Phoenix red terminals → all 24V loads</li>
                <li><strong>V−:</strong> To Phoenix black terminals → all 24V returns</li>
              </ul>
            </div>
            ...
            <div class="info-box">
              ...
              <div class="specs-grid">
                ...
                <div class="spec-row"><span class="spec-label">Distribution:</span><span class="spec-value">Phoenix red (5V+) and black (5V−)</span></div>
              </div>
            </div>
            ...
            <!-- CONTROL & MOTION -->
            <h4 style="color:#60a5fa;font-weight:700;margin:2rem 0 1rem;font-size:1.2rem;">🎮 Control & Motion System</h4>
            ...
            <div class="info-box">
              ...
              <ul style="color:#cbd5e1;line-height:1.6;margin-left:1.5rem;">
                <li><strong>PU+ / PU−:</strong> Differential step pulses to driver</li>
                <li><strong>DR+ / DR−:</strong> Differential direction signal</li>
                <li><strong>MF+ / MF−:</strong> Motor-free / enable signal</li>
            ...
            <div class="info-box">
              ...
              <div class="specs-grid">
                ...
                <div class="spec-row"><span class="spec-label">Control Inputs:</span><span class="spec-value">PU+/PU−, DR+/DR−, MF+/MF−</span></div>
                <div class="spec-row"><span class="spec-label">Motor Outputs:</span><span class="spec-value">A+, A−, B+, B− (bipolar)</span></div>
              </div>
              <div class="note-callout" style="margin-top:1rem;">
                <strong>Signal Chain:</strong> DN31C01 (commands) → NOM Driver (current shaping) → X-Axis Stepper (motion)
              </div>
            </div>
            ...
            <div class="info-box">
              ...
              <div class="specs-grid">
                ...
                <div class="spec-row"><span class="spec-label">Phase A:</span><span class="spec-value">A+ (Red), A− (Green)</span></div>
                <div class="spec-row"><span class="spec-label">Phase B:</span><span class="spec-value">B+ (Yellow), B− (Blue)</span></div>
                <div class="spec-row"><span class="spec-label">Mounting:</span><span class="spec-value">Right rear feeder carriage</span></div>
              </div>
            </div>
            
            <!-- SENSORS -->
            <h4 style="color:#60a5fa;font-weight:700;margin:2rem 0 1rem;font-size:1.2rem;">👁️ Sensing System</h4>
            ...
            <div class="info-box">
              ...
              <div class="specs-grid">
                ...
                <div class="spec-row"><span class="spec-label">Power:</span><span class="spec-value">Vcc → 24V from Dinkle supply</span></div>
                <div class="spec-row"><span class="spec-label">Signal:</span><span class="spec-value">OUT1 → DN31C01 input</span></div>
                <div class="spec-row"><span class="spec-label">Ground:</span><span class="spec-value">GND → 0V reference</span></div>
              </div>
              ...
              <div class="note-callout" style="margin-top:1rem;">
                <strong>Operation:</strong> When interrupter flag blocks beam, OUT1 toggles state → DN31C01 reads digital signal for position/presence feedback.
              </div>
            </div>
            
            <!-- PNEUMATICS -->
            <h4 style="color:#60a5fa;font-weight:700;margin:2rem 0 1rem;font-size:1.2rem;">💨 Pneumatic Control System</h4>
            ...
            <div class="info-box">
              ...
              <ol style="color:#cbd5e1;line-height:1.6;margin-left:1.5rem;">
                ...
                <li><strong>Power Flow:</strong> +24V flows from Red Phoenix Terminal → Pin 11 → Pin 14 → Solenoid V+</li>
...
Phoenix Red (24V+) → Upstream Relay/Driver → V+ Solenoid → Coil → GND Solenoid → Phoenix Black (0V) → Dinkle PSU V−
              </div>
            ...
            <!-- WIRING & INTEGRATION -->
            <h4 style="color:#60a5fa;font-weight:700;margin:2rem 0 1rem;font-size:1.2rem;">🔌 Wiring & Integration</h4>
          ...
          <div class="tab-content" id="tab-operation">
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                <strong>AC Path:</strong> 200-240V AC → Main breakers (Doepke G16 + Nader NDB1L-32) → 120V branch "Right Rear Feeder Control" → UKK80 L2/N2 distribution blocks<br><br>
                <strong>DC Supplies:</strong><br>
                • Dinkle 24V PSU: 120V AC → 24V DC to driver, sensor, solenoids, CAP circuits<br>
                • Mean Well 5V PSU: 120V AC → 5V DC to DN31C01 logic and control circuits
              </div>
            </div>
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                • DN31C01 powered and ready, communicating with main system<br>
                • Stepper driver enabled via MF signal, holding torque on X-axis if required<br>
                • EE-SX950W sensor powered (24V), OUT1 in default state (no flag interruption)<br>
                • All solenoid outputs de-energized, pneumatic valves in rest position
              </div>
            </div>
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                • DN31C01 receives move command from main controller<br>
                • Sets direction via DR+/DR− differential pair to driver<br>
                • Generates step pulses on PU+/PU− at commanded rate<br>
                • NOM driver shapes current into motor phases: A+/A−, B+/B−<br>
                • X-axis stepper rotates, moving right rear feeder carriage horizontally
              </div>
            </div>
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                • As carriage moves, interrupter flag may enter EE-SX950W optical slot<br>
                • Sensor beam blocked → OUT1 toggles state<br>
                • DN31C01 reads OUT1 transition:<br>
                &nbsp;&nbsp;→ Stop motion if home position reached<br>
                &nbsp;&nbsp;→ Zero X-axis reference<br>
                &nbsp;&nbsp;→ Activate overtravel interlock if end limit detected<br>
                &nbsp;&nbsp;→ Verify part present in expected location
              </div>
            </div>
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                ...
                <ol style="margin-left:1.5rem;color:#cbd5e1;line-height:1.8;">
                  ...
                  <li><strong>24V Power Flow:</strong> Phoenix Red (24V) → Pin 11 → Pin 14 → Solenoid V+</li>
                  <li><strong>Solenoid Energizes:</strong> 24V flows through solenoid coil → electromagnet engages → valve shifts</li>
                  ...
                  <li><strong>De-energize:</strong> DN31C01 removes signal → relay opens → solenoid spring-returns to rest position</li>
                </ol>
                <div class="note-callout" style="margin-top:1rem;">
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                • <strong>When relay/driver closes:</strong> 24V applied, solenoid energizes, CAP circuit capacitor charges to 24V<br>
                • <strong>When relay/driver opens:</strong> Solenoid coil current stops, magnetic field collapses<br>
                • <strong>Inductive kickback:</strong> Collapsing field generates voltage spike (can exceed 100V)<br>
                • <strong>CAP absorbs spike:</strong> RC network or diode clamps transient, dissipates energy safely<br>
                • <strong>Protection achieved:</strong> Relay contacts protected from arcing, 24V rail stays clean, no noise injected into signal wires
              </div>
            </div>
            ...
            <div class="info-box" style="margin-top:2rem;">
              ...
              <ul style="color:#cbd5e1;line-height:1.8;margin-left:1.5rem;">
                ...
                <li><strong>Dinkle PSU Terminals:</strong> Verify 24V DC on V+ / V− outputs (Phoenix red/black)</li>
                <li><strong>Mean Well 5V Terminals:</strong> Confirm 5V DC presence for logic circuits</li>
                <li><strong>Driver A/B Outputs:</strong> Verify proper phase wiring to stepper (A+/A−, B+/B− to correct colors)</li>
            ...
            <div class="note-callout" style="margin-top:1.5rem;background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;">
              ...
              • 1× DN31C01 microcontroller<br>
              • 1× NOM stepper driver (D40/D50)<br>
              • 1× X-axis stepper motor (4-wire bipolar)<br>
              • 1× EE-SX950W optical sensor<br>
              • 6× CAP circuits (5 standard V+/GND + 1 V+/Cathode)<br>
              • 6× Solenoid outputs (24V V+/GND connections)
            </div>
          </div>
        `
      },
      'air-distribution': {
        getHTML: () => `
          <div class="tab-navigation">
            <button class="tab-btn active" data-tab="overview"><span class="tab-icon">ℹ️</span>Overview</button>
            <button class="tab-btn" data-tab="flow"><span class="tab-icon">💨</span>Air Flow</button>
            <button class="tab-btn" data-tab="components"><span class="tab-icon">🔧</span>Components</button>
            <button class="tab-btn" data-tab="operation"><span class="tab-icon">⚙️</span>Operation</button>
          </div>
          ...
          <div class="tab-content active" id="tab-overview">
            ...
            <div class="warning-box">
              <h4>⚠️ Critical Understanding:</h4>
              <ul>
          ...
          <div class="tab-content" id="tab-components">
            ...
            <h4 style="font-weight:700;margin:1.5rem 0 1rem;color:#60a5fa;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">🖥️ Arduino Nano DN31C01 Microcontroller</h4>
            ...
            <div class="info-box">
              <h4>⭐ Communication with Main Controller:</h4>
            ...
            <div class="danger-box">
              <h4>⚠️ Why This Microcontroller Is Critical:</h4>
            ...
            <h4 style="font-weight:700;margin:2rem 0 1rem;color:#60a5fa;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">🔌 41F-1Z-C2-5 Relay Socket</h4>
            ...
            <div class="info-box">
              ...
              <div class="note-callout" style="background:rgba(251,191,36,0.1);border-left:4px solid #fbbf24;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
                ...
                <ul style="margin-top:0.5rem;margin-left:1.5rem;color:#cbd5e1;line-height:1.6;">
                  ...
                  <li>Flow: <strong>Inputs → Logic → Outputs → Machine Movement</strong></li>
                </ul>
              </div>
            </div>
            
            <h4 style="font-weight:700;margin:2rem 0 1rem;color:#60a5fa;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">🎨 Feeder Solenoid Modules (Clay, Almond, White)</h4>
            ...
            <h4 style="font-weight:700;margin:2rem 0 1rem;color:#60a5fa;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">💨 Screw Distribution Manifold</h4>
            ...
            <h4 style="font-weight:700;margin:2rem 0 1rem;color:#60a5fa;border-bottom:2px solid rgba(148,163,184,0.3);padding-bottom:0.5rem;">🔴⚫ Phoenix DIN Rail Terminals</h4>
            ...
            <div class="flow-diagram" style="max-width:800px;margin:0 auto;">
              ...
              <div style="text-align:center;font-size:2.5rem;color:#94a3b8;margin:1.5rem 0;">↓</div>
          ...
          <div class="tab-content" id="tab-operation">
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                ...
                <p style="margin-top:0.5rem;color:#fbbf24;font-weight:600;">⚠️ Only ONE feeder can be activated at a time</p>
              </div>
            </div>
            ...
            <div class="operation-step">
              ...
              <div class="step-content">
                ...
                <div style="background:rgba(220,38,38,0.1);padding:1rem;border-radius:0.5rem;border-left:4px solid #dc2626;margin-top:0.5rem;">
                  <strong style="color:#dc2626;">+24V (Pin 2 - Red terminal) → Relay → Pin 1 (Blue) → Solenoid</strong>
                </div>
            ...
            <div class="info-box">
              <h4>🔁 Relay Contact Operation Detail:</h4>
              ...
              <div style="background:rgba(99,102,241,0.1);padding:1rem;border-radius:0.5rem;border-left:4px solid #6366f1;margin-top:1rem;">
                ...
                <span style="color:#cbd5e1;">Red Terminal (+24V) → Pin 2 → Relay Contacts (11-14) → Pin 1 → Solenoid Coil → Pin 5 → Black Terminal (0V)</span>
              </div>
            </div>
            
            <div class="footer-warning">
              <strong>⚠️ Critical:</strong> The relay provides electrical isolation between the low-power microcontroller logic (5V) and the high-power solenoid circuit (24V). This prevents damage to the DN31C01 and ensures reliable operation.
            </div>
          </div>
        `
      }
  ...
  'rcd': {
    ...
    connections: [
      ...
      '<strong>Pin 2:</strong> Line OUT (to UKK80 → whole machine)',
  ...
  'safety-relay': {
    ...
    specs: {
      ...
      'Control Current': '≈30mA over S12, S22',
  ...
  'finder-contactor': {
    ...
    function: 'Electrically controlled AC power switch. DOLD controls the coil (A1-A2) which electromagnetically closes/opens the power contacts (1→3, 2→4).',
    connections: [
      '<strong>A1:</strong> Coil input from DOLD safety relay',
      '<strong>A2:</strong> Coil return to Neutral',
      '<strong>1→2:</strong> AC power contact (L1 in/out)',
      '<strong>3→4:</strong> AC power contact (second switched line)',
      '<strong>Selector:</strong> ON/AUTO/OFF switch'
    ],
    specs: {
      'Coil Circuit': 'Low-power control (A1-A2) creates magnetic field',
      'Power Circuit': 'High-current AC switching (1→3, 2→4)',
  ...
  'psu-48v': {
    ...
    specs: {
      ...
      'Conversion': 'AC→EMI filter→rectifier→PFC→switching→transformer→DC'
    }
  },
  'psu-24v': {
    ...
    specs: {
      ...
      'Conversion': 'AC→EMI filter→bridge rectifier→PWM→transformer→DC filter'
    }
  },
  'psu-aux': {
  ...
  'rcd-breaker': {
    ...
    connections: [
      ...
      '<strong>Sequence:</strong> Wall → Nader → Doepke → System'
    ],
    specs: {
      ...
      const componentData = {
        ...
        'doepke': {
          ...
          content: `
            ...
            <div class="note-callout" style="margin-top:1rem;">
              <strong>Power Flow:</strong> Wall AC → Nader → Doepke → UKK160 → Power Supplies
            </div>
          `
        },
        ...
        'ukk160': {
          ...
          content: `
            ...
            <div class="note-callout" style="margin-top:1rem;">
              ...
              • +24V bus (Line UKK160) feeds loads<br>
              • 0V/Return bus (Neutral UKK160) provides DC return<br>
              • PE/Earth bus (Yellow Green TB) provides safety bonding
            </div>
          `
        },
        ...
        'psu-24v': {
          ...
          content: `
            ...
            <div class="info-box" style="margin-top:1rem;">
              ...
              <ul style="margin-left:1.5rem;line-height:1.8;">
                <li><strong>Vo+ (24V+):</strong> Goes to Line UKK160 → DN31C01, relays, solenoids, driver logic</li>
                <li><strong>Vo− (0V):</strong> Goes to Neutral UKK160 → Return path for all 24V loads</li>
        ...
        'dn31c01': {
          ...
          content: `
            ...
            <div class="info-box" style="margin-top:1rem;">
              <h4>🧠 The "PLC Brain" of the Feeder</h4>
        ...
        'dn31c01-motor': {
          name: 'DN31C01 → Motor Control',
          content: `
            <div class="info-box">
              <h4>Motor Control Signals</h4>
              <ul style="margin-left:1.5rem;line-height:1.8;">
                <li><strong>PU− (Pulse/Step):</strong> Each pulse = one microstep forward</li>
                <li><strong>DR− (Direction):</strong> Controls left or right movement</li>
              </ul>
            </div>
            <div class="note-callout" style="margin-top:1rem;">
              <strong>How It Works:</strong><br>
              • DN31C01 generates step pulses at specific frequency<br>
              • Pulse frequency controls motor speed<br>
              • Number of pulses controls distance traveled<br>
              • Direction signal determines which way motor turns
            </div>
            <div class="info-box" style="margin-top:1rem;">
        ...
        'dn31c01-pneumatic': {
          name: 'DN31C01 → Pneumatic Control',
          content: `
            <div class="info-box">
            ...
            <div class="note-callout" style="margin-top:1rem;">
              ...
              3. Relay closes contacts 11→14<br>
        ...
        'driver': {
          ...
          content: `
            ...
            <div class="info-box" style="margin-top:1rem;">
              <h4>🎛️ The "Brain of the Motor"</h4>
            ...
            <div class="note-callout" style="margin-top:1rem;">
              <strong>Signal Chain:</strong> DN31C01 (commands) → FMDD50D40NOM (coil control) → X Stepper Motor (movement)
            </div>
            <div class="note-callout" style="margin-top:1rem;">
              <strong>Note:</strong> PU+ and DR+ are tied to +5V (common-anode wiring). Driver automatically enables when MF+/MF− left disconnected.
            </div>
          `
        },
        ...
        'motor': {
          ...
          content: `
            <div class="specs-grid">
              <div class="spec-row"><span class="spec-label">Type:</span><span class="spec-value">NEMA 23 Bipolar Stepper</span></div>
              <div class="spec-row"><span class="spec-label">Phases:</span><span class="spec-value">2-phase (A and B coils)</span></div>
              <div class="spec-row"><span class="spec-label">Connections:</span><span class="spec-value">A+, A−, B+, B− (4 wires)</span></div>
            ...
            <div class="info-box" style="margin-top:1rem;">
              <h4>💪 The "Muscle" of the System</h4>
        ...
        'relays': {
          ...
          content: `
            <div class="specs-grid">
              ...
              <div class="spec-row"><span class="spec-label">Quantity:</span><span class="spec-value">4 relays (one per solenoid)</span></div>
              <div class="spec-row"><span class="spec-label">Coil Terminals:</span><span class="spec-value">A1, A2 (control input from DN31C01)</span></div>
              <div class="spec-row"><span class="spec-label">Contact Terminals:</span><span class="spec-value">11→14 (switches 24V to solenoid)</span></div>
              <div class="spec-row"><span class="spec-label">Coil Voltage:</span><span class="spec-value">24V DC (or controlled by DN31C01 output)</span></div>
            </div>
            <div class="info-box" style="margin-top:1rem;">
              <h4>Function</h4>
            ...
            <div class="info-box" style="margin-top:1rem;">
              ...
              <ol style="margin-left:1.5rem;line-height:1.8;">
                ...
                <li><strong>Step 4:</strong> +24V flows from Red Phoenix Terminal → Pin 11 → Pin 14 → Solenoid V+</li>
          ...
          content: `
            ...
            <div class="info-box" style="margin-top:1rem;">
              ...
              <ul style="margin-left:1.5rem;line-height:1.8;">
                ...
                <li><strong>GND:</strong> 0V return to Phoenix Black Terminal → Neutral UKK160 → PSU</li>
              </ul>
            </div>
            <div class="note-callout" style="margin-top:1rem;">
              ...
              24V PSU Vo+ → Line UKK160 → Relay 11→14 → Solenoid V+ → Solenoid Coil → Solenoid GND → Phoenix Black Terminal → Neutral UKK160 → PSU Vo−
              </code>
            </div>
            <div class="info-box" style="margin-top:1rem;">
            ...
            <div class="note-callout" style="margin-top:1rem;">
              <strong>Energized State:</strong> Coil creates electromagnetic field → valve shifts → air flows → cylinder moves<br>
              <strong>De-energized State:</strong> Spring returns valve to rest position → air stops/exhausts
            </div>
          `
        },
        ...
        'optical-sensors': {
          ...
          content: `
            ...
            <div class="info-box" style="margin-top:1rem;">
              <h4>How It Works</h4>
              <ul style="margin-left:1.5rem;line-height:1.8;">
                <li><strong>Beam Clear:</strong> IR LED light hits phototransistor → OUT1 goes HIGH</li>
                <li><strong>Beam Blocked:</strong> Part/flag blocks slot → OUT1 goes LOW</li>
                <li>DN31C01 monitors OUT1 to detect: home position, limit confirmation, jam detection</li>
              </ul>
            </div>
        ...
        'red-phoenix': {
          ...
          content: `
            ...
            <div class="note-callout" style="margin-top:1rem;">
              ...
              24V PSU → Red Phoenix → Relay Pin 11<br>
              When relay closes (11→14), 24V flows to solenoid coils
            </div>
          `
        }
      };
...
const POWER_COMPONENT_DETAILS = {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(168,85,247,0.1);border-left:4px solid #a855f7;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <ul style="margin-top:0.5rem;margin-left:1.5rem;color:#cbd5e1;">
          ...
          <li>If any safety input opens → relay de-energizes → contactor drops out → system powers down</li>
  ...
  'finder-contactor': {
    ...
    content: `
      ...
      <div class="warning-box" style="margin-top:1rem;">
        <h4>⚠️ Safety Function:</h4>
        <p style="color:#cbd5e1;">When E-stop is pressed or safety interlock opens, DOLD relay de-energizes contactor coil → contacts open → ALL AC power is disconnected. System cannot restart until safety conditions are restored and manual reset is performed.</p>
      </div>
    `
  },
  'ukk-terminals': {
          ...
          panel.innerHTML = `
            <div style="padding: ${isPowerSupply ? '3.5rem 2rem' : '2.5rem 1rem'};">
              ...
              <div style="text-align:center;margin-top:${isPowerSupply ? '3rem' : '2rem'};">
                <button onclick="this.closest('.power-detail-panel').previousElementSibling.click()" style="background:rgba(239,68,68,0.2);border:2px solid #ef4444;color:#ef4444;padding:0.75rem 1.5rem;border-radius:0.5rem;cursor:pointer;font-size:0.95rem;font-weight:600;">✕ Close</button>
              </div>
            </div>
          `;
  ...
  'x-motor': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(34,197,94,0.1);border-left:4px solid #22c55e;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <p style="color:#cbd5e1;margin-top:0.5rem;">FMDD50D40 NOM driver sends alternating current to A and B coils → rotor rotates in precise microsteps → horizontal positioning of right rear feeder cradle</p>
      </div>
    `
  },
  'relays': {
  ...
  'solenoids': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(37,99,235,0.1);border-left:4px solid #2563eb;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <p style="color:#cbd5e1;margin-top:0.5rem;">DN31C01 activates relay → Relay closes → 24V flows to solenoid coil → Valve opens → Compressed air flows → Pneumatic action</p>
      </div>
      <div class="info-box" style="margin-top:1rem;">
  ...
  'cap-circuits': {
    ...
    content: `
      ...
      <div class="specs-grid" style="margin-top:1rem;">
        ...
        <div class="spec-row"><span class="spec-label">Configuration:</span><span class="spec-value">5× V+/GND, 1× V+/Cathode</span></div>
      </div>
      <div class="warning-box" style="margin-top:1rem;">
        <h4>⚠️ Critical Protection:</h4>
  ...
  'ee-sx950w': {
    ...
    content: `
      ...
      <div class="specs-grid" style="margin-top:1rem;">
        ...
        <div class="spec-row"><span class="spec-label">Output:</span><span class="spec-value">OUT1 → DN31C01</span></div>
      </div>
      <div class="note-callout" style="background:rgba(37,99,235,0.1);border-left:4px solid #2563eb;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        <strong>Function:</strong>
        <p style="color:#cbd5e1;margin-top:0.5rem;">Detects X-axis home position and part presence. When beam is broken, OUT1 signal changes state → DN31C01 reads this for position reference.</p>
      </div>
    `
  },
  'dn31c01': {
...
const MOTOR_COMPONENT_DETAILS = {
  'sdr-480-48': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(220,38,38,0.1);border-left:4px solid #dc2626;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        <strong>Distribution:</strong>
        <p style="color:#cbd5e1;margin-top:0.5rem;">Phoenix Red Terminal → Individual fuses → All 4 motor drivers (X, Y, Z, 4th)</p>
  ...
  'ndr-240-24': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        <strong>Distribution:</strong>
        <p style="color:#cbd5e1;margin-top:0.5rem;">Phoenix Red → WAGO 221 Vlogic Splicer → All 4 motor control boards</p>
  ...
  'ndr-120-12': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        <strong>Distribution:</strong>
        <p style="color:#cbd5e1;margin-top:0.5rem;">Phoenix Red Terminal → Auxiliary systems requiring 12V DC</p>
      </div>
    `
  },
  'mean-well-5v': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(220,38,38,0.1);border-left:4px solid #dc2626;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <ul style="margin-top:0.5rem;margin-left:1.5rem;color:#cbd5e1;">
          ...
          <li><strong>24V:</strong> To WAGO 221 Vlogic splicer → 4 motor boards</li>
  ...
  'phoenix-black': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <p style="color:#cbd5e1;margin-top:0.5rem;">Phoenix Black → WAGO Ground Splicer → All 4 motor boards (GND inputs)</p>
  ...
  'y-driver': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(236,72,153,0.1);border-left:4px solid #ec4899;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <p style="color:#cbd5e1;margin-top:0.5rem;">STEP/DIR/EN from motion controller → precise Y-axis positioning</p>
  ...
  'y-motor': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(34,197,94,0.1);border-left:4px solid #22c55e;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        <strong>Operation:</strong>
        <p style="color:#cbd5e1;margin-top:0.5rem;">Driver sends alternating current to A and B coils in precise sequence → rotor rotates in microsteps → precise Y-axis positioning</p>
      </div>
    `
  },
  'z-motor': {
  ...
  'sensors': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(37,99,235,0.1);border-left:4px solid #2563eb;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <p style="color:#cbd5e1;margin-top:0.5rem;">System moves each axis until sensor beam is broken → establishes home position (zero reference) → all subsequent moves calculated from this point</p>
      </div>
    `
  },
  'encoders': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(37,99,235,0.1);border-left:4px solid #2563eb;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <p style="color:#cbd5e1;margin-top:0.5rem;">Encoder pulses continuously report actual position → controller compares to commanded position → corrects for any missed steps or positioning errors</p>
      </div>
    `
  },
  'light-bars': {
  ...
  'motion-controller': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <p style="color:#cbd5e1;margin-top:0.5rem;">G-code command → Motion planning → Pulse generation → STEP/DIR to boards → Coordinated multi-axis motion</p>
      </div>
    `
  },
  ...
  'phoenix-summary': {
    ...
    content: `
      ...
      <div class="note-callout" style="background:rgba(99,102,241,0.1);border-left:4px solid #6366f1;padding:1rem;border-radius:0.5rem;margin-top:1rem;">
        ...
        <p style="color:#cbd5e1;margin-top:0.5rem;">PCUs → Phoenix Terminals → WAGO Splicing → Motor Control Boards</p>
      </div>
    `
  },
  'motor-boards-summary': {
    ...
    content: `
      ...
      <div class="warning-box" style="margin-top:1rem;">
        <h4>⚠️ Z-Axis Special Feature:</h4>
...
const AIR_COMPONENT_DETAILS = {
  ...
  'dn31c01': {
    ...
    content: `
      ...
      <div class="warning-box" style="margin-top:1rem;">
        <h4>⚠️ From PDF:</h4>
        <p style="color:#cbd5e1;">"The main machine does NOT micromanage air feeding — this microcontroller does it."</p>
    ...
    <div id="airDetailModal" style="display:none;">
      <div style="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.85);z-index:9999;display:flex;align-items:center;justify-content:center;padding:2rem;">
        <div style="background:#1a1f35;border:2px solid rgba(148,163,184,0.3);border-radius:1rem;padding:2rem;max-width:700px;width:90%;max-height:80vh;overflow-y:auto;position:relative;box-shadow:0 20px 60px rgba(0,0,0,0.5);">
          <button id="airDetailClose" style="position:absolute;top:1rem;right:1rem;background:rgba(239,68,68,0.2);border:1px solid #ef4444;color:#ef4444;padding:0.5rem 1rem;border-radius:0.5rem;cursor:pointer;font-size:0.9rem;font-weight:600;border:2px solid #ef4444;">✕ Close</button>
